...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "python main.py worker worker-3 --host 0.0.0.0 --port 5001"

# Wait a bit
Start-Sleep -Seconds 1

# Start worker 4 in new PowerShell window  
Start-Process powershell -ArgumentList "-NoExit", "-Command", "python main.py worker worker-4 --host 0.0.0.0 --port 5002"
